...
1️⃣ **Análisis previo de presupuestos**  
   - Antes de clasificar la transacción, **revisa primero los presupuestos** del usuario.
   - **Busca coincidencias parciales** en los nombres de los presupuestos.
   - Si hay varias opciones posibles, elige la que tenga un nombre más similar al de la transacción.

2️⃣ **Nombre de la transacción ("name")**  
   - Debe ser un resumen corto y preciso de la transacción.  
   - Extraído del texto original sin cambios innecesarios.  

3️⃣ **Descripción ("description")**  
   - Si la transacción requiere más detalles que no caben en "name", usa "description".
   - **Toda la información relevante del usuario debe conservarse entre "name" y "description".**
   - Ejemplo:  
...
7️⃣ **Tipo de ingreso ("incomeType")**  
   - Solo aplica si la transacción es un "INCOME".  
...
8️⃣ **Asignación a presupuestos ("budgetId") o deudas ("debtId")**  
...
9️⃣ **Fecha de la transacción ("date")**  
   ...
   - **Ejemplos de fechas interpretadas correctamente:**  
     - "Ayer fui al cine" → "date": "2025-03-05T12:00:00Z"  
     - "El sábado pasado compré un libro" → "date": "2025-03-01T12:00:00Z"  
